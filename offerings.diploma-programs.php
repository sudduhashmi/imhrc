...
<!-- DIPLOMA PROGRAMS (Other Academic Offerings) -->
<!-- HERO: Other Academic Offerings / Diploma Programs -->
<header class="hero">
  <div class="container">
    <div class="row align-items-center">
      
      <div class="col-lg-8">
        <span class="badge-accent">Other Academic Offerings / Diploma Programs</span>
        <h1 class="mt-3">Diploma Programs in Psychology & Mental Health</h1>
        <p>
          IMHRC Diploma Programs under Other Academic Offerings are professionally designed
          to provide in-depth training in psychology and mental health. Students gain
          supervised clinical exposure, practical skill development, and industry-recognized
      ...
      <div class="col-lg-4 text-center">
        <img src="assets/img/images.jpeg" 
             ...
             alt="Diploma Programs in Psychology">
      </div>
...
<!-- OTHER ACADEMIC OFFERINGS: DIPLOMA PROGRAMS -->
...
<h4 class="fw-bold">Why Choose IMHRC Diploma Programs</h4>
<p>
IMHRC Diploma Courses focus on applied learning and real-world psychological
practice, making students career-ready for clinical, counselling and mental
health roles.
</p>

<ul class="list-unstyled">
<li><i class="bi bi-check2-circle me-2"></i> Clinical & Counselling specialization</li>
<li><i class="bi bi-check2-circle me-2"></i> Online, Offline & Hybrid modes</li>
<li><i class="bi bi-check2-circle me-2"></i> Supervised internship & case exposure</li>
...
<strong class="text-black"> Diploma Programs Offered</strong>
<p class="small text-muted mt-1">
Clinical Psychology Diploma, Counselling Psychology Diploma,
Mental Health Practice Diploma & IGNOU MAPC Internship Diploma.
</p>
</div>
</div>
</aside>
...
<li class="nav-item"><a class="nav-link active" href="#" onclick="filterCategory(event,'all')">All Diploma Programs</a></li>
<li class="nav-item"><a class="nav-link" href="#" onclick="filterCategory(event,'clinical')">Clinical Diploma</a></li>
<li class="nav-item"><a class="nav-link" href="#" onclick="filterCategory(event,'counselling')">Counselling Diploma</a></li>
</ul>
...
<input id="searchBox" oninput="applyFilters()" class="form-control form-control-sm" style="max-width:160px" placeholder="Search programs">
</div>
...
<div class="row mt-5">
<div class="col-12">
<h3 class="section-title">Diploma Programs – FAQs</h3>
<div class="accordion" id="faqAcc">

<div class="accordion-item">
<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#f1">
Who can apply for diploma programs?
</button>
<div id="f1" class="accordion-collapse collapse">
<div class="accordion-body">
UG/PG students, psychology graduates, counselors, teachers and
mental health professionals can apply.
</div>
</div>
</div>
...
Do diploma programs include internship?
</button>
<div id="f2" class="accordion-collapse collapse">
<div class="accordion-body">
Yes. Most diploma programs include supervised internship,
case documentation and clinical exposure.
</div>
</div>
</div>
...
<div class="accordion-body">
Yes. IMHRC diploma certificate mentioning duration,
training hours and competencies is issued.
</div>
</div>
</div>
...
<script>
const programs=[
{id:1,title:"Diploma in Clinical Psychology",category:"clinical",mode:"offline",duration:"12 Months",fee:"₹25,000",desc:"Assessment, diagnosis and therapeutic intervention with supervised clinical exposure."},
{id:2,title:"Diploma in Counselling Psychology",category:"counselling",mode:"hybrid",duration:"9 Months",fee:"₹20,000",desc:"Professional counselling skills, ethics, case formulation and therapy techniques."},
{id:3,title:"Diploma in Mental Health Practice",category:"clinical",mode:"online",duration:"6 Months",fee:"₹15,000",desc:"Applied mental health practices and community-based interventions."},
{id:4,title:"IGNOU MAPC Internship Diploma",category:"clinical",mode:"offline",duration:"240 Hours",fee:"₹8,000",desc:"IGNOU aligned internship with supervision, reports and certification."}
];
...
renderPrograms(cat==='all'?programs:programs.filter(p=>p.category===cat));
}

function applyFilters(){
const m=document.getElementById('modeFilter').value;
renderPrograms(m==='all'?programs:programs.filter(p=>p.mode===m));
}

function populateForm(){
document.getElementById('formProgram').innerHTML=programs.map(p=>`<option value="${p.id}">${p.title}</option>`).join('');
}
